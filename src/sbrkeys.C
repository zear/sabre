...
//  {   0,  0,    0,   FI_NO_KEY }
  ...
  {   0,  0,    0,   FI_YOKE_LEFT },
  {   0,  0,    0,   FI_YOKE_RIGHT },
  {   0,  0,    0,   FI_YOKE_CENTER },
  {   0,  0,    0,   FI_YOKE_TRIM_UP },
  {   0,  0,    0,   FI_YOKE_TRIM_DOWN },
  {   0,  0,    0,   FI_YOKE_TRIM_CENTER },
  {   0,  0,    0,   FI_THROTTLE_FULL },
  {   0,  0,    0,   FI_THROTTLE_ZERO },
  { 'U',  0,  0,   FI_THROTTLE_PLUS },
  { 'D',  0,  0,   FI_THROTTLE_MINUS },
  {   0,  0,    0,   FI_RUDDER_LEFT },
  {   0,  0,    0,   FI_RUDDER_RIGHT },
  {   0,  0,    0,   FI_RUDDER_CENTER },
  {   0,  0,    0,   FI_FLAPS_TOGGLE },
  {   0,  0,    0,   FI_FLAPS_PLUS },
  {   0,  0,    0,   FI_FLAPS_MINUS },
  {   0,  0,    0,   FI_GEAR_TOGGLE },
  {   'L',  0,    0,   FI_SPEED_BRAKES_TOGGLE },
  {   'R',  0,    0,   FI_WHEEL_BRAKES_TOGGLE },
  {   'l',  0,    0,   FI_AUTOPILOT_TOGGLE },
  {   0,  0,    0,   FI_HUD_TOGGLE },
  {   0,  0,    0,   FI_PAUSE_TOGGLE },
  {   0,  0,    0,   FI_WEAPON_ARM_TOGGLE },
  { 'a',   0,   0,   FI_BANG_BANG },
  { 'r',  0,    0,   FI_NEXT_WEAPON },
  { CR,  'T',  't',  FI_NEXT_TARGET },
  {   0,   0,   0,   FI_COCKPIT_TOGGLE },
  {  'x', 0,    0,   FI_NEXT_VIEW_NODE },
  {   0,  0,    0,   FI_PLAYER_VIEW_NODE },
  {   'y',  0,    0,   FI_VIEW_FRONT },
  {   0,  0,    0,   FI_VIEW_FRONT_UP },
  {   0,  0,    0,   FI_VIEW_FRONT_DOWN },
  {   0,  0,    0,   FI_VIEW_LEFT },
  {   0,  0,    0,   FI_VIEW_LEFT_UP },
  {   0,  0,    0,   FI_VIEW_LEFT_DOWN },
  {   0,  0,    0,   FI_VIEW_RIGHT },
  {   0,  0,    0,   FI_VIEW_RIGHT_UP },
  {   0,  0,    0,   FI_VIEW_RIGHT_DOWN },
  {   'b',  0,    0,   FI_VIEW_REAR },
  {   0,  0,    0,   FI_VIEW_REAR_UP },
  {   0,  0,    0,   FI_VIEW_REAR_DOWN },
  {   0,  0,    0,   FI_VIEW_FRONT_LEFT },
  {   0,  0,    0,   FI_VIEW_FRONT_LEFT_UP },
  {   0,  0,    0,   FI_VIEW_FRONT_LEFT_DOWN },
  {   0,  0,    0,   FI_VIEW_FRONT_RIGHT },
  {   0,  0,    0,   FI_VIEW_FRONT_RIGHT_UP },
  {   0,  0,    0,   FI_VIEW_FRONT_RIGHT_DOWN },
  {   0,  0,    0,   FI_VIEW_REAR_LEFT },
  {   0,  0,    0,   FI_VIEW_REAR_LEFT_UP },
  {   0,  0,    0,   FI_VIEW_REAR_LEFT_DOWN },
  ...
  {   0,  0,    0,   FI_VIEW_UP },
  {   0,  0,    0,   FI_VIEW_DOWN },
  {   0,  0,    0,   FI_VIEW_SATELLITE },
  {   0,  0,    0,   FI_VIEW_EXTERNAL },
  {   0,  0,    0,   FI_VIEW_TRACK },
  {   0,  0,    0,   FI_VIEW_TARGET_TRACK },
  {   0,  0,    0,   FI_VIEW_FLYBY },
  {   0,  0,    0,   FI_VIEW_WEAPON_TRACK },
  {   0,  0,    0,   FI_VIEW_VIRTUAL },
  {   0,  0,    0,   FI_VIEW_VIRTUAL_SNAP_FRONT },
  {   0,  0,    0,   FI_VIEW_THETA_PLUS },
  {   0,  0,    0,   FI_VIEW_THETA_MINUS },
  {   0,  0,    0,   FI_VIEW_PHI_PLUS },
  {   0,  0,    0,   FI_VIEW_PHI_MINUS },
  {   0,  0,    0,   FI_VIEW_PADLOCK },
  {   0,  0,    0,   FI_EXTERN_VIEW_DISTANCE_PLUS },
  {   0,  0,    0,   FI_EXTERN_VIEW_DISTANCE_MINUS },
  {   0,  0,    0,   FI_WIREFRAME_TOGGLE },
  {   0,  0,    0,   FI_FRAMERATE_TOGGLE },
  {   0,  0,    0,   FI_DISPLAY_CLOUDS_TOGGLE },
  {   0,  0,    0,   FI_DISPLAY_TEXTURED_GROUND_TOGGLE },
  {   0,  0,    0,   FI_FLIGHTPATH_INDICATOR_TOGGLE },
  {   0,  0,    0,   FI_RADAR_TOGGLE },
  {   0,  0,    0,   FI_PLANEFRAME_TOGGLE },
  {   0,  0,    0,   FI_CONTROL_POSITIONS_INDICATOR_TOGGLE },
  {   0,  0,    0,   FI_SCREEN_DUMP },
  {   0,  0,    0,   FI_NO_KEY }
};
